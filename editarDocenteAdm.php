...
$docente = DocenteController::buscarDocente($_GET['id']);
?>
            ...
            <div id="content">
                ...
                <body id="page-top">
                    <div id="wrapper">
                        ...
                        <div id="content-wrapper" class="d-flex flex-column">
                            <div id="content">
                                <!-- Topbar - Removed for simplicity -->
                                <div class="container-fluid">
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Adicionar Professor</h6>
                                        </div>
                                        <div class="card-body">
                                            <form action="./php/rotas.php" method="POST">
                                                <input type="hidden" name="acao" value='atualizar_docente'>
                                                <input type="hidden" name="docente_id" value="<?php echo $docente['id'] ?>">
                                                <div class="form-group">
                                                    <label for="matricula">Matrícula:</label>
                                                    <input type="text" class="form-control" value="<?php echo $docente['matricula'] ?>" id="matricula" name="matricula" required>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="coordenador">RG:</label>
                                                    <input type="text" class="form-control" id="rg" name="rg" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="coordenador">Nome:</label>
                                                    <input type="text" class="form-control" value="<?php echo $docente['nome'] ?>" id="nome" name="nome" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="coordenador">Data de Nascimento:</label>
                                                    <input type="text" class="form-control" id="dataNascimento" name="nascimento" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="coordenador">Endereço:</label>
                                                    <input type="text" class="form-control" id="endereco" name="endereco" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="coordenador">Telefone:</label>
                                                    <input type="text" class="form-control" id="telefone" name="telefone" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="coordenador">Email:</label>
